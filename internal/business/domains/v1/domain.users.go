...
type UserUsecase interface {
	...
	VerifyOTP(ctx context.Context, email string, userOTP string, otpRedis string) (statusCode int, err error)
...
type UserRepository interface {
	...
	GetAllUsers(ctx context.Context) (outDom []UserDomain, err error)
}
