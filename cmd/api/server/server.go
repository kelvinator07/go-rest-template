...
import (
	...
	"github.com/kelvinator07/go-rest-template/internal/http/middlewares"
	"github.com/kelvinator07/go-rest-template/internal/http/routes"
...
func (a *App) Run() (err error) {
	// Gracefull Shutdown
	go func() {
		logger.InfoF("success now listening on port :%d", logrus.Fields{constants.LoggerCategory: constants.LoggerCategoryServer}, config.AppConfig.Port)
